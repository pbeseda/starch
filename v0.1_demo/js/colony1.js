...
var force = d3.layout.force()
    ...
    .charge(-200 * colony.scale)
    .linkDistance(100 * colony.scale)
    .on('tick', function() {
...
node.enter()
    ...
    .attr('cy', function(d) { return d.y })
    .attr('r', function(d) {
        return scale * (d.root ? 5 : d.module && !d.native ? 5 : 5)
    })
    ...
    .on('click', function(d) {
        ...
        */
        ...
        force.charge(function(o) {
            return (o.active ? -100 : -50) * colony.scale
        }).linkDistance(function(l) {
            return (l.source.active && l.target.active ? 75 : 50) * colony.scale
